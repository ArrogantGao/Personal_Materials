...
\begin{frame}
	...
	Now we have some results on 2D cases by adaptively refining the corners:
...
\begin{frame}
	...
	I also collaborate with Shidong and Jiuyang for a DMK based solver to achieve $O(\log{N})$ update complexity in Monte Carlo simulations of charged particles systems.
